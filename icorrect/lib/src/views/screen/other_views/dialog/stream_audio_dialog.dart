...
class _SliderAudioState extends State<SliderAudio> {
  ...
  void initState() {
    ...
    _audioPlayer.onPositionChanged.listen((newPosition) {
      _provider!.setPositionAudioSample(newPosition + Duration(seconds: 1));
    });
  }
            ...
            Column(
              ...
              children: [
                ...
                Slider(
                    ...
                    value: provider.positionAudioSample.inSeconds.toDouble(),
                ...
                (provider.isSamplePlaying)
                    ? InkWell(
                        ...
                        child: const Icon(Icons.pause_circle_filled_rounded,
                            size: 60, color: AppColor.defaultPurpleColor),
                      )
                    : InkWell(
                        onTap: () async {
