...
class TestRoomNewWidget extends StatefulWidget {
  ...
  @override
  State<TestRoomNewWidget> createState() => _TestRoomWidgetState();
}

class _TestRoomWidgetState extends State<TestRoomNewWidget>
    with
        WidgetsBindingObserver,
        AutomaticKeepAliveClientMixin<TestRoomNewWidget>
